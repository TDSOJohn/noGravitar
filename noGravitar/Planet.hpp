...
public:
    ...
    bool                updatePlanet(Spaceship&, const sf::Time&, sf::Vector2f&, bool, bool);      //Return is 1 if spaceship alive, 0 is dead. Spaceship, Time since last frame, isShooting, isGrabbing
