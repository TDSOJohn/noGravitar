...
Overlay::Overlay(Settings::gameStates* gState, int* scr, const ResourceHolder<sf::Texture, Textures::ID>& textures) : youWonMessage(textures.get(Textures::Won)), youLostMessage(textures.get(Textures::Lost))
{
    score = scr;
    gameState = gState;
